...
- [x] **Task 3: Инструмент `get_element_details`** 8208e81
...
- [x] **Task 4: Обновление System Prompt (Security Policy)** 8208e81
...
- [x] **Task 5: Обновление System Prompt (Failure Protocol)** 8208e81
    - [x] Правило: "If stuck for 3 steps or looping -> call `task_failed`".

## Phase 3: Verification [checkpoint: 0d95c64]
Проверка на реальных сценариях.

- [x] **Task 6: Тест безопасности (Mock)** 0d95c64
...
- [x] **Task 7: Тест диалога** 0d95c64
    - [x] Запустить агента.
    - [x] Попросить "Спроси меня, как дела".
    - [x] Ответить в консоли.
    - [x] Убедиться, что агент понял ответ.

- [x] **Task: Conductor - User Manual Verification 'Phase 3: Verification' (Protocol in workflow.md)** 0d95c64
